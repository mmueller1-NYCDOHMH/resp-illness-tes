...
const { colors, colorScales } = tokens;
...
const themeMap = {
  "COVID-19": {
    ...
    chartColor: colorScales.covid[1],
    background: colors.bgPurple,
    pillBackground: colors.bgLightPurple,
    icon: resolveAsset('assets/covid-vector.svg'),
  },
  Flu: {
    color: colors.tealPrimary,
    chartColor: colorScales.flu[1],
    background: colors.bgTeal,
    pillBackground: colors.bgLightTeal,
    icon: resolveAsset('assets/flu-vector.svg'),
  },
  RSV: {
    color: colors.orangePrimary,
    chartColor: colorScales.rsv[1],
    background: colors.bgOrange,
    pillBackground: colors.bgLightOrange,
    icon: resolveAsset('assets/rsv-vector.svg'),
  },
  "Overall respiratory illness": {
    color: colors.bluePrimary,
    chartColor: colors.blueAccent,
    background: colors.bgBlue,
    icon: resolveAsset('assets/ari-vector.svg'),
  },
};
